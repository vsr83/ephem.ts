...
import { TimeConvention, TimeCorrelation } from '../src';
    ...
    describe('iau1980', function() {
        it('IAU SOFA', function() {
            ...
            for (let indJT = 0; indJT < iauSofaData.length; indJT++)
            {
                ...
                const timeStamp = timeCorr.computeTimeStamp(JTtdb, TimeConvention.TIME_TDB, false);
                const nutData : NutationData = Nutation.iau1980(timeStamp);

                console.log(nutData.eps + " " + eps);
