...
export class Hipparcos
{
     ...
     */
    static hipparcosGet(designation : string, timeStamp : TimeStamp) : HipparcosOut
    {
        ...
        const deltaJT = timeStamp.JTtdb - epochJ1991_25;

        const hipData : {[index : string] : HipparcosEntry} = hipparcosData;
        const starData = this.properMotion(hipData[designation], timeStamp.JTtdb);
